...
public class Tests
{
    ...
    [TestCase("a", new int[]{1, 1}, "abc")]
    [TestCase("b", new int[]{0, 1}, "kbc")]
    [TestCase("c", new int[0], "c")]
    [TestCase("d", 
    ...
    public void SimpleTest(string expected, int[] coordinates, string letters)
    {
        var actual = _lastSurvivor.GetLastSurvivorNumber(letters, coordinates);
